...
My doctoral research investigates how agentic AI systems can be coupled with structured engineering knowledge and physics-based simulation to produce outputs that engineers can trust and deploy. I came to this question through hands-on work at the intersection of generative AI and software engineering practice---building knowledge-graph systems that model research and engineering problems as first-class entities, and studying how generative tools handle (and mishandle) evidence-based reasoning~\cite{Ji2023HallucinationSurvey}. Working with Dr.~Afsari and her construction.ai initiative crystallized the gap I now want to close: large language models can describe a beam, but they cannot certify that it will hold, and engineering disciplines reject what they cannot verify. The Amazon-VT Fellowship would let me dedicate the next year to closing that verification gap directly, in a setting that combines academic rigor with industry-scale infrastructure.
...
This fellowship would fund the central year of my dissertation. With Dr.~Afsari as my advisor, I gain direct mentorship from a researcher whose construction.ai initiative places VVUQ and engineering knowledge representation at the center of her group's work---an unusual combination that maps cleanly onto AKG-E's three layers. The fellowship's Amazon connection is equally load-bearing: AKG-E targets deployment via Amazon Bedrock Knowledge Bases~\cite{AWSBedrockHybridSearch2024}, and direct interaction with Amazon's applied AI and construction logistics teams would let me ground the framework against real engineering data pipelines rather than only academic benchmarks. My training plan for the fellowship year is to (i)~complete and validate the construction-domain implementation, (ii)~extend AKG-E to a second domain to evidence the domain-agnostic claim, (iii)~publish the VVUQ-agent integration methodology and benchmarks, and (iv)~present the work at venues spanning AI for engineering and the agentic AI community.

\section*{Qualifications and Trajectory}

My prior work has built directly toward this dissertation. I am co-author of a study on the evidence-based reasoning behaviors of generative AI tools in software engineering~\cite{BrownCusati2025SEBeliefs}, which exposed exactly the verification weaknesses AKG-E now sets out to address. I am the architect of an open agentic knowledge-graph system for research progression that models research problems and constraints as first-class entities, and which supplies the orchestration substrate AKG-E reuses. With Dr.~Afsari I am also developing a construction-domain knowledge-graph and computer-vision pipeline for automated material takeoff, which is the working prototype of AKG-E's construction pilot. I have completed VT's PhD coursework in AI-driven software engineering, knowledge-grounded generation, and applied research methods, and am positioned to dedicate the fellowship year to dissertation execution rather than coursework or qualifying-exam preparation.

\section*{Expected Impact}

AKG-E aims to convert generative outputs into certified, decision-ready engineering artifacts---reducing hallucinated designs, enforcing code compliance, and enabling principled human-in-the-loop thresholds. As a fellow, my deliverables would include an open AKG-E framework, domain-adaptable KG templates, and reproducible VVUQ benchmarks for agentic engineering systems. I set a benchmark target of $>$50\% constraint violation reduction versus unconstrained LLM baselines as an evaluation design goal. Beyond the dissertation, the framework's Amazon-Bedrock integration path is direct: it connects AKG-E to AWS-scale engineering data pipelines and makes the contribution immediately relevant to Amazon's applied AI and construction logistics workflows.
