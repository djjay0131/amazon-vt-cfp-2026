...
\noindent\textbf{Primary Topic:} Multi-Agent Systems and Collaborations \hfill
\textbf{Secondary:} Data Integration / Retrieval (Hybrid)
...
\section{Proposed Approach: PA-AKG}
...
\section{Team, Timeline, and Open Source}
