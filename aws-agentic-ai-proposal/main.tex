...
\midrule
Cusati GRA stipend (12 mo, 100\% effort) & \$30,000 \\
...
\newpage
\section*{Appendix B: CV of PI}

\includepdf[scale=1.0,offset=1in -1in,pages=-,width=8in]{Brown.pdf}

\section*{Appendix C: Previously Funded Project Summary}
