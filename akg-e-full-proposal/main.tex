...
\author{
    ...
    \IEEEauthorblockA{Code World, No Blanket Lab \\
...
\textbf{Dr.~Kereshmeh Afsari (PI)} directs the ARCADE Lab at the Myers-Lawson School of Construction, with deep expertise in BIM, 3D visualization, and the construction-AI initiative that supplies AKG-E's primary domain testbed; she owns the ARCADE infrastructure (BIM/IFC datasets, simulation pipelines, AWS account) and the construction-industry partnerships that anchor the LVL pilot. \textbf{Dr.~Chris Brown (Co-PI)} contributes expertise in software engineering tooling~\cite{bose2025autopydep,ko2025autoprint} and empirical evaluations of AI-generated code~\cite{khalid2025evaluating,ko2024understanding}. The Brown--Cusati study of LLM behavior~\cite{brown2025exploring} on software engineering tasks surfaced the verification weaknesses AKG-E sets out to close. Co-PI Brown also advises the student-research thread on agentic KGs~\cite{cusati2026fose}. \textbf{Jason Cusati (Student Researcher)} brings the agentic-KG research-progression substrate that supplies AKG-E's orchestration layer, the VTTI VTSI calculator (and its digital-twin extension proposal) that anchors the transportation domain, and direct VVUQ training under Dr.~Christopher Roy's graduate coursework (Oberkampf--Roy formulation~\cite{Oberkampf2010VVUQ}).
